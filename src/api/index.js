...
export const getBooks = async () => {
    const url = 'http://192.168.43.140:3000/api/books'
    try {
...
export const getBooksid = async (id) => {
    const url = 'http://192.168.43.140:3000/api/books/' + id
    try {
        const response = await fetch(url, {
            method: 'GET',
            headers: {
...
export const getBooksIdUser = async (id) => {
    const url = 'http://192.168.43.140:3000/api/booksUser/' + id
    try {
        const response = await fetch(url, {
            method: 'GET',
            headers: {
...
export const getCommandeIdUser = async (id) => {
    const url = 'http://192.168.43.140:3000/api/commande/' + id
    try {
        const response = await fetch(url, {
            method: 'GET',
            headers: {
...
export const postUser = async (login , mdp) => {
    const url = 'http://192.168.43.140:3000/api/login/'
...
export const postUserRegister = async (prenom,nom,login,mdp,telephone,email) => {
    const url = 'http://192.168.43.140:3000/api/sign-up/'
...
export const postCommandeBook = async (datelivraison , adresselivraison, id_user, id) => {
    const url = 'http://192.168.43.140/api/commandeBooks/' + id
    try {
        const response = await fetch(url, {
            method: 'POST',
            headers: {
...
export const postCommandeBookid = async (idcommandeBooks, id) => {
    const url = 'http://192.168.43.140:3000/api/commandeBooksid/' + id
    try {
        const response = await fetch(url, {
            method: 'POST',
            headers: {
...
export const getToken = async (token) => {
    const url = 'http://192.168.43.140:3000/api/secret-route/'
    try {
        const response = await fetch(url, {
            method: 'GET',
            headers: {
